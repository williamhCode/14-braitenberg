...
def main():
    ...
    bugImg = pygame.image.load('pic/bug.png')
    ...
    lightImg = pygame.image.load('pic/light.png')
    ...
    button1 = button((100,100,100),200,300,200,100,'Basic Bug',pygame.font.SysFont('comicsans', 50))
    button2 = button((100,100,100),500,300,200,100,'Fearful Bug',pygame.font.SysFont('comicsans', 50))
    button3 = button((100,100,100),800,300,200,100,'Aggro Bug',pygame.font.SysFont('comicsans', 50))
